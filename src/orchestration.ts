...
- Treat root handoff.md as a private minimum resume capsule. When writes are permitted, rewrite it before final delivery of substantive work with only the latest demand, current status, immediate next action, and blocker/review state. Keep it below 4,096 tokens and the 12,000-character bootstrap ceiling. Record progress, task outcomes, verification, and blockers in tracked PROGRESS.md. Never include secrets or raw logs. Do not mutate either file in plan mode.
